            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._plasmaContract.getExit(slot)];
                    case 1:
                        exit = _a.sent();
                        return [2 /*return*/, {
                                slot: slot,
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._plasmaContract.checkMembership(leaf, root, slot, proof)];
                    case 1:
                        isIncluded = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._plasmaContract.getBlockRoot(blockNumber)];
                    case 1:
                        root = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        slot = params.slot, from = params.from;
                        return [4 /*yield*/, this._plasmaContract.getPlasmaCoin(slot)];
                    case 1:
                        coin = _a.sent();
                        return [2 /*return*/, {
                                slot: slot,
